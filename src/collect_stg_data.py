...
base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Data', 'Data Hospital'))
output_sql_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'db', 'stg_data'))
